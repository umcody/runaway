...
const survey = [
  {
    ...
    questionText: "What brings you to this chat?",
    questionId: "Reason",
    questionSettings: {
      maxMultiSelect: 2,
      minMultiSelect: 0,
    ...
    options: [
      {
        optionText: "Understanding Emotions/Feelings",
        value: "Emotions_Feelings",
      },
      {
        optionText: "Life Challenges (e.g. illness or loss)",
        value: "Life_Challenges",
      },
      {
        optionText: "Use or Abuse of substance",
        value: "Substance",
      },
      {
        optionText: "Anxiety/Depression",
        value: "Anxiety_Depression",
      },
      {
        optionText: "Friendship",
        value: "Friendship",
      },
      {
        optionText: "Relationship",
        value: "Relationship",
      },
      {
        optionText: "Unhealthy Behavior",
        value: "Behavior",
      },
      {
        optionText: "Other",
  ...
  {
    questionType: "MultipleSelectionGroup",
    questionText: "Have you had suicidal thoughts in the past 6 months?",
    questionId: "suicidal",
    questionSettings: {
      maxMultiSelect: 1,
      minMultiSelect: 0,
