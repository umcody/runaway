...
import { StyleSheet, View, Text,ScrollView,Dimensions,SectionList } from "react-native";
  ...
  return (
    ...
    <ScrollView>
     ...
     <TouchableOpacity activeOpacity={.9} style={styles.button}>
        <Text style={{color:'#fff',fontWeight:'bold',fontSize:18}}>Visit Our Site</Text>
     </TouchableOpacity>
      </View>
      <View style = {styles.team} activeOpacity={.9}>
          <Text style = {styles.subtitle}>Team</Text>
          <Text style = {{fontSize:18,color:'#2E5F85',paddingBottom:20}}>Meet the team behind Runaway.</Text>
          <View style = {{alignItems:'center',width:'100%'}}>
            ...
            <TeamCard name ="Rebecca Gorman" role="Director of Content & Media"></TeamCard>
            ...
            <TeamCard name ="Dybe Fredy Mwaisyange" role="Project Manager"></TeamCard>
